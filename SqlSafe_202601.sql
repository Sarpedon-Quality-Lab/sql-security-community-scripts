...
SELECT
    15 AS [Check ID],
    'Database Chaining Enabled' AS [Check Name],
    name Result1,
...
SELECT
    '050' AS [Check ID],
    'Number of ErrorLogs kept' AS [Check Name],
    CASE
...
SELECT
    '155' AS [Check ID],
    'Database Owner not valid' AS [Check Name],
    dbname AS Result1,
...
BEGIN
    ...
    SELECT
        ''802'' AS CheckID,
        ''Contained Availability Groups'' AS CheckName
		,	COUNT(*) AS Result1
