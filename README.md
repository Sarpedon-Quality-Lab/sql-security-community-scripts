...
Unblock-File .\SqlSafe_202602.sql
```
...
6. Open the generated HTML report in the `Results` folder.
...
- `SqlSafe_202602.sql` — T-SQL assessment logic
...
Get-FileHash .\SqlSafe_202602.sql -Algorithm SHA256
```
